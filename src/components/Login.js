...
const Login = () => {
    ...
    return (
        <div>
            ...
            <div>
                <form onSubmit={(e) => e.preventDefault()} className="absolute md:p-12  bg-black bg-opacity-85 p-8 m-14 md:w-3/12 md:my-36 md:mx-auto mt-20   right-0 left-0 text-white rounded-lg">
